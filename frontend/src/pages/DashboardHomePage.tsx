        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center mb-3">
              ...
              <h3 className="ml-3 text-xl font-semibold text-gray-900">Emendas</h3>
            </div>
            <p className="text-gray-600">Gerencie emendas parlamentares</p>
          </Link>
          ...
          >
            <div className="flex items-center mb-3">
              ...
              <h3 className="ml-3 text-xl font-semibold text-gray-900">Instituições</h3>
            </div>
            <p className="text-gray-600">Cadastre e gerencie instituições</p>
          </Link>
          ...
          >
            <div className="flex items-center mb-3">
              ...
              <h3 className="ml-3 text-xl font-semibold text-gray-900">Parlamentares</h3>
            </div>
            <p className="text-gray-600">Gerencie dados dos parlamentares</p>
          </Link>
        </div>
      )}
    </div>
